  ...
  var Vim = function() {
    ...
    var createCircularJumpList = function() {
      ...
      function add(cm, oldCur, newCur) {
        ...
        function useNextSlot(cursor) {
          ...
          buffer[next] = cm.setImagemark(cursor);
        }
        if (curMark) {
    ...
    * match the input selection.
      ...
      paste: function(cm, actionArgs, vim) {
        ...
        if (vim.visualMode) {
          ...
          if(lastSelectionCurEnd) {
            vim.lastSelection.headMark = cm.setImagemark(lastSelectionCurEnd);
          }
          if (linewise) {
            curPosFinal.ch=0;
          }
    ...
    function updateLastSelection(cm, vim) {
      ...
      vim.lastSelection = {'anchorMark': cm.setImagemark(anchor),
                           'headMark': cm.setImagemark(head),
    ...
    * in the right place.
    ...
    function updateMark(cm, vim, markName, pos) {
      ...
      vim.marks[markName] = cm.setImagemark(pos);
    }
    ...
    */
    ...
    function updateFakeCursor(cm) {
      ...
      if (from.ch == cm.getLine(from.line).length) {
        ...
        vim.fakeCursorImagemark = cm.setImagemark(from, {widget: widget});
      } else {
    ...
    function clearFakeCursor(vim) {
      ...
      if (vim.fakeCursorImagemark) {
        vim.fakeCursorImagemark.clear();
        vim.fakeCursorImagemark = null;
      }
    }
