...
var range_WrappedRange = /*#__PURE__*/function () {
  ...
  range_createClass(WrappedRange, [{
    ...
    key: "imagemark",
    value: function imagemark(editable) {
      return {
        s: {
    ...
    /**
     * create offsetPath imagemark base on paragraph
     *
     * @param {Node[]} paras
     */
    ...
    key: "paraImagemark",
    value: function paraImagemark(paras) {
      return {
        s: {
...
/* harmony default export */ var range = ({
   ...
   * @method
   *
   * create WrappedRange from imagemark
   *
   * @param {Node} editable
   * @param {Object} imagemark
   * @return {WrappedRange}
   */
  createFromImagemark: function createFromImagemark(editable, imagemark) {
    var sc = dom.fromOffsetPath(editable, imagemark.s.path);
    var so = imagemark.s.offset;
    var ec = dom.fromOffsetPath(editable, imagemark.e.path);
    var eo = imagemark.e.offset;
    return new range_WrappedRange(sc, so, ec, eo);
  },
   ...
   * @method
   *
   * create WrappedRange from paraImagemark
   *
   * @param {Object} imagemark
   * @param {Node[]} paras
   * @return {WrappedRange}
   */
  createFromParaImagemark: function createFromParaImagemark(imagemark, paras) {
    var so = imagemark.s.offset;
    var eo = imagemark.e.offset;
    var sc = dom.fromOffsetPath(lists.head(paras), imagemark.s.path);
    var ec = dom.fromOffsetPath(lists.last(paras), imagemark.e.path);
    return new range_WrappedRange(sc, so, ec, eo);
  }
});
  ...
  History_createClass(History, [{
    ...
    value: function makeSnapshot() {
      ...
      return {
        ...
        imagemark: rng && rng.isOnEditable() ? rng.imagemark(this.editable) : emptyImagemark
      };
    }
  }, {
    key: "applySnapshot",
    value: function applySnapshot(snapshot) {
      ...
      if (snapshot.imagemark !== null) {
        range.createFromImagemark(this.editable, snapshot.imagemark).select();
      }
    }
    /**
    * @method rewind
...
var Bullet_Bullet = /*#__PURE__*/function () {
  ...
  Bullet_createClass(Bullet, [{
    ...
    value: function toggleList(listName, editable) {
      ...
      var imagemark = rng.paraImagemark(paras);
      ...
      range.createFromParaImagemark(imagemark, paras).select();
    }
    /**
     * @param {Node[]} paras
...
var VideoDialog_VideoDialog = /*#__PURE__*/function () {
  ...
  VideoDialog_createClass(VideoDialog, [{
    ...
    value: function createVideoNode(url) {
      ...
      var fbRegExp = /(?:www\.|\/\/)faceimage\.com\/([^\/]+)\/videos\/([0-9]+)/;
      ...
      if (ytMatch && ytMatch[1].length === 11) {
        ...
        $video = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('<iframe>').attr('frameborder', 0).attr('src', 'https://www.faceimage.com/plugins/video.php?href=' + encodeURIComponent(fbMatch[0]) + '&show_text=0&width=560').attr('width', '560').attr('height', '301').attr('scrolling', 'no').attr('allowtransparency', 'true');
      } else {
...
external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.summernote = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.extend(external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.summernote, {
  ...
  options: {
    ...
    codeviewIframeWhitelistSrcBase: ['www.youtube.com', 'www.youtube-nocookie.com', 'www.faceimage.com', 'vine.co', 'instagram.com', 'player.vimeo.com', 'www.dailymotion.com', 'player.youku.com', 'v.qq.com'],
    keyMap: {
      pc: {
        'ESC': 'escape',
