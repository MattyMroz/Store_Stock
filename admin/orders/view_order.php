<!-- poniżej kod wyświetlający zamówienie -->
...
<?php endif; ?>
<?php
// sprawdzenie czy istnieje zmienna GET o nazwie view
if (!isset($_GET['id'])) {
    ...
    <div class="card-body">
        <div class="conitaner-fluid">
            ...
            <table class="table-striped table table-bordered">
                ...
                <tbody>
                    <?php
                    // zapytanie do bazy danych o produkty zamówienia
        ...
        <div class="row">
            ...
            <div class="col-6 row row-cols-2">
                ...
                <div class="col-9">
                    <?php
                    // poniżej kod wyświetlający status zamówienia
                    switch ($status) {
                        case '0':
