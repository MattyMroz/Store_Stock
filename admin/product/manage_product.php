        ...
        <form action="" id="product-form">
            ...
            <div class="form-group">
                ...
                <select name="category_id" id="category_id" class="custom-select select2" required>
                    <option value=""></option>
                    <?php
                    // zapytanie do bazy danych o kategorie
            ...
            <div class="form-group">
                ...
                <select name="sub_category_id" id="sub_category_id" class="custom-select" required>
                    ...
                    <?php
                    // zapytanie do bazy danych o podkategorie
            ...
            <?php
            // poniższy kod słurzy do wyświetlania obrazków, sprawdzamy czy jest zmienna $id czyli czy jest edycja
            if (isset($id)) :
