    ...
    <div class="container-fluid px-4 px-lg-5 ">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                ...
                <?php
                // zapytanie do bazy danych o każdy element menu
                ...
                <?php endwhile; ?>
                <?php if ($count_cats > 3) : ?>
                    <li class="nav-item"><a class="nav-link" href="./?p=view_categories">Categories</a></li>
                <?php endif; ?>
                    ...
                    <a class="text-dark mr-2 nav-link" href="./?p=cart">
                        ...
                        <span class="badge bg-dark text-white ms-1 rounded-pill" id="cart-count">
                            ...
                            if (isset($_SESSION['userdata']['id'])) :
                                // zapytanie do bazy danych o ilość produktów w koszyku
