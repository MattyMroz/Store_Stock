    ...
    <div class="container">
        ...
        <div class="card rounded-0">
            <div class="card-body">
                ...
                <?php
                // zapynie do bazy o listę produktów w koszyku
                    ...
                    <div class="d-flex w-100 justify-content-between  mb-2 py-2 border-bottom cart-item">
                        <div class="d-flex align-items-center col-8">
                            ...
                            <div>
                                ...
                                <p class="mb-1 mb-sm-1"><small><b>Price:</b> <span class="price"><?php echo number_format($row['price']) ?> zł</span></small></p>
                                <div>
...
<script>
    // poniższy kod służy do obsługi koszyka
    function calc_total() {
        var total = 0
