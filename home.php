...
<header class="bg-dark py-5" id="main-header">
    <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
            <h1 class="display-4 fw-bolder">If you want to make intelligent, get images from here.</h1>
...
<section class="py-5">
    <div class="container px-4 px-lg-5 mt-5">
        <div class="row gx-4 gx-lg-5 row-cols-md-3 row-cols-xl-4 justify-content-center">
            <?php
            // zapytanie do bazy o listę pakietów
            ...
            ?>
                <div class="col mb-5">
                    <div class="card product-item">
                        <!-- Product image-->
                        <img class="card-img-top w-100 image-cover" src="<?php echo validate_image($img) ?>" alt="..." />
                        <!-- Product details-->
